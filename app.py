...
_DIAGRAM_PLANNER_PROMPT = (
    ...
    "**The slide is a DIAGRAM, not a poster.** It MUST have at least 2 "
    ...
    "Even if the concept is simple, break it into a comparison, a 2-stage "
    "flow, a hub with satellites, a labeled scene, or annotated callouts.\n\n"
    "If you can't think of how to split it, default to: a centered SCENE "
    "with 3-5 labeled callout boxes pointing at parts of the scene. Each "
